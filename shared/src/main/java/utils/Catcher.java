...
public final class Catcher {
    ...
    public static <T, E extends Exception> T throwNew(Class<E> exceptionClass, String message) throws E {
        createError(exceptionClass, new Class[]{String.class}, new Object[]{message});
        return null;
    }

    public static <T, E extends Exception> T throwNew(Class<E> exceptionClass) throws E {
        createError(exceptionClass, new Class[0], new Object[0]);
        return null;
    }
    //endregion
    ...
    private static <T, R extends Throwable> T tryCatchRethrowInner(
        ...
        return tryCatchInner(supplier, catchClass, rethrowClass, e -> {
            createError(throwAsClass, new Class[]{String.class, Throwable.class}, new Object[]{errorMessage.apply(e), e});
            createError(throwAsClass, new Class[]{String.class}, new Object[]{errorMessage.apply(e)});
        });
    }
